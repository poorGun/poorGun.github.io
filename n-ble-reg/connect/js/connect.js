...
window.onload = function () {
    ...
    setTimeout(() => {
        ...
        if (isDark) {
            ...
            this.document.getElementsByClassName('btn')[0].style.background = '#317af7';
            this.document.getElementsByClassName('btn')[0].style.color = 'rgba(255,255,255,0.86)';
        }
    ...
    // ipad适配
    if (isPad && isPortrait) {
        document.getElementsByClassName('btn')[0].style.width = 'calc(100vw - (100vw - 1.2rem *9) / 8 * 5 - 1.2rem * 7)';
        document.getElementsByClassName('box')[0].style.width = 'calc(100vw - (100vw - 1.2rem *9) / 8 * 2 - 1.2rem * 4)';
        document.getElementsByClassName('box')[0].style.margin = 'auto';
    }
};
...
function getSystemInfo() {
        ...
        try {
            ...
            window.resCallback = res => {
                if (res === 2) {
                    ...
                    isDark = false;
                    this.document.getElementsByClassName('connect-content')[0].style.background = '#f1f3f5';
                    this.document.getElementById('app').style.background = '#f1f3f5';
                    this.document.getElementsByClassName('detail')[0].style.color = 'rgba(0, 0, 0, 0.9)';
                    this.document.getElementsByClassName('failConnect')[0].style.color = 'rgba(0, 0, 0, 0.9)';
                    this.document.getElementsByClassName('progress')[0].style.color = 'rgba(0, 0, 0, 0.9)';
                    this.document.getElementsByClassName('progressDes')[0].style.color = 'rgba(0,0,0,0.6)';
                }
            };
        } catch (err) {
    ...
    // 暗黑模式标题颜色
    var bg = isDark ? '#ffffff' : '#000000';
    if (window.hilink) {
        console.log('isDark', isDark);
        window.hilink.modifyTitleBar(isDark, bg, 'setTextresultCallback');
